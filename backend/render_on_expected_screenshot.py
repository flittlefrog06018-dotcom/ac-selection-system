...
src_file = os.path.join(artifacts_dir, "media__1785671768738.jpg")
out_path = os.path.join(artifacts_dir, "user_expected_screenshot_rendered.jpg")
...
print(f"Successfully rendered expected screenshot overlay to {out_path} ({w}x{h})")
