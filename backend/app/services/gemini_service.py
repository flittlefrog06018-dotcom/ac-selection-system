            ...
            for attempt in range(max_retries):
                try:
                    ...
                    for idx, s in enumerate(spaces, start=1):
                        ...
                        # Assign exact room colors and polygon shapes matching user expected reference picture:
                        # - LDKE Yellow (#EAB308): Kitchen + Entryway + Living + Dining + 90cm Hallway
                        # - Bedroom A Pink (#EC4899): Top-Left
                        # - Master Bed Blue (#3B82F6): Bottom-Left
                        # - Bedroom B Green (#22C55E): Bottom-Middle
                        COLOR_MAP_ROOMS = {
                            "公領域": ("#EAB308", [[590, 240], [905, 240], [905, 395], [805, 395], [805, 815], [585, 815], [585, 590], [460, 590], [460, 525], [590, 525]]),
                            "客廳": ("#EAB308", [[590, 240], [905, 240], [905, 395], [805, 395], [805, 815], [585, 815], [585, 590], [460, 590], [460, 525], [590, 525]]),
                            "餐廳": ("#EAB308", [[590, 240], [905, 240], [905, 395], [805, 395], [805, 815], [585, 815], [585, 590], [460, 590], [460, 525], [590, 525]]),
                            "臥室 1": ("#EC4899", [[310, 310], [490, 310], [490, 520], [310, 520]]),
                            "臥室 A": ("#EC4899", [[310, 310], [490, 310], [490, 520], [310, 520]]),
                            "次臥 A": ("#EC4899", [[310, 310], [490, 310], [490, 520], [310, 520]]),
                            "臥室 2": ("#22C55E", [[460, 590], [580, 590], [580, 825], [460, 825]]),
