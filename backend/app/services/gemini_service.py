...
def get_prompt_rule_4() -> str:
    return BASE_CORE_PROMPT + """
    【當前模式：電子圖面 JPG/PNG 高解析圖片 (🔴 標準地毯式審查紀律 🔴)】
    - 必須地毯式掃描圖面上所有標註有繁體中文名稱與 m2/坪數 的空間，一個都不能遺漏！
    """
    ...
    def _get_mock_spaces(filename: str) -> List[Dict[str, Any]]:
        ...
        if "v13" in fn or "test_v13" in fn:
            ...
            return [
                ...
                {"space_name": "浴室一", "area_raw": 14.8, "unit": "m2", "polygon": [[320, 400], [560, 400], [560, 680], [320, 680]]},
                {"space_name": "浴室二", "area_raw": 10.5, "unit": "m2", "polygon": [[100, 630], [310, 630], [310, 800], [100, 800]]},
                {"space_name": "餐廳", "area_raw": 38.0, "unit": "m2", "polygon": [[100, 80], [420, 80], [420, 370], [100, 370]]},
                {"space_name": "玄關", "area_raw": 8.8, "unit": "m2", "polygon": [[330, 80], [560, 80], [560, 200], [330, 200]]},
                {"space_name": "走道", "area_raw": 9.0, "unit": "m2", "polygon": [[330, 200], [560, 200], [560, 400], [330, 400]]},
                {"space_name": "工作陽台", "area_raw": 12.5, "unit": "m2", "polygon": [[100, 810], [310, 810], [310, 940], [100, 940]]}
            ]
