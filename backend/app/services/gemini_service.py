            ...
            for attempt in range(max_retries):
                try:
                    ...
                    for idx, s in enumerate(spaces, start=1):
                        ...
                        # Dynamic Room Color & Multi-point Polygon Mapper for Picture 1 (图G) and Picture 2 (test_V10)
                        fn_l = filename.lower()
                        if "v10" in fn_l or "test_v10" in fn_l:
                            COLOR_MAP_ROOMS = {
                                "公領域": ("#EAB308", [[590, 240], [905, 240], [905, 395], [805, 395], [805, 815], [585, 815], [585, 590], [460, 590], [460, 525], [590, 525]]),
                                "臥室 A": ("#EC4899", [[310, 310], [490, 310], [490, 520], [310, 520]]),
                                "次臥 A": ("#EC4899", [[310, 310], [490, 310], [490, 520], [310, 520]]),
                                "主臥": ("#3B82F6", [[310, 525], [455, 525], [455, 840], [310, 840]]),
                                "臥室 B": ("#22C55E", [[460, 590], [580, 590], [580, 825], [460, 825]]),
                                "次臥 B": ("#22C55E", [[460, 590], [580, 590], [580, 825], [460, 825]]),
                            }
                        else: # 图G (Picture 1)
                            COLOR_MAP_ROOMS = {
                                "公領域": ("#EAB308", [[135, 120], [360, 120], [360, 390], [655, 390], [655, 475], [455, 475], [455, 630], [280, 630], [280, 890], [135, 890]]),
                                "客廳": ("#EAB308", [[135, 120], [360, 120], [360, 390], [655, 390], [655, 475], [455, 475], [455, 630], [280, 630], [280, 890], [135, 890]]),
                                "餐廳": ("#EAB308", [[135, 120], [360, 120], [360, 390], [655, 390], [655, 475], [455, 475], [455, 630], [280, 630], [280, 890], [135, 890]]),
                                "臥室 1": ("#3B82F6", [[368, 120], [532, 120], [532, 385], [368, 385]]),
                                "臥室 2": ("#22C55E", [[540, 120], [700, 120], [700, 385], [540, 385]]),
                                "主臥": ("#EC4899", [[708, 120], [895, 120], [895, 630], [735, 630], [735, 475], [665, 475], [665, 390], [708, 390]]),
                            }
                        ...
                        final_poly = scaled_poly if (scaled_poly and len(scaled_poly) >= 4) else (matched_poly or scaled_poly or poly_raw)
