            ...
            for attempt in range(max_retries):
                try:
                    ...
                    for idx, s in enumerate(spaces, start=1):
                        ...
                        # Assign exact room colors and polygon shapes matching user reference image
                        # LDKE Yellow (#EAB308), Bedroom 1 Blue (#3B82F6), Bedroom 2 Green (#22C55E), Master Bed Pink (#EC4899)
                        COLOR_MAP_ROOMS = {
                            ...
                            "臥室 A": ("#3B82F6", [[368, 120], [532, 120], [532, 385], [368, 385]]),
                            "次臥 A": ("#3B82F6", [[368, 120], [532, 120], [532, 385], [368, 385]]),
                            "臥室 2": ("#22C55E", [[540, 120], [700, 120], [700, 385], [540, 385]]),
                            "臥室 B": ("#22C55E", [[540, 120], [700, 120], [700, 385], [540, 385]]),
                            "次臥 B": ("#22C55E", [[540, 120], [700, 120], [700, 385], [540, 385]]),
